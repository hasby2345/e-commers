            ...
            <div class="row align-items-center gy-5">
                <div class="col-lg-6">
                    <div class="about-img" data-aos="fade-right">
                        <img src="{{asset('backend/assets/images/homepage-one/about/abaut.webp')}}" alt="img">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-content" data-aos="fade-up">
                        <h3 class="about-title">Tahu Lebih Banyak Tentang Kami?</h3>
                        <p class="about-info" >
                            E-commerce ini merupakan industri kerajinan tangan yang berkembang pesat di era digital saat
                            ini. Ini mencakup penjualan berbagai
                            produk kerajinan tangan seperti
                            barang rajutan, keramik, perhiasan, lukisan, dan banyak lagi melalui platform online.</p>
        ...
        <div class="about-service-section">
            <div class="about-wrapper">
                ...
                <div class="wrapper-info">
                    ...
                    <p>Pilihan produk yang mungkin
                        anda sukai dengan hiasan-hiasan
                        sentuhan seni yang indah dimata
                    </p>
                </div>
            </div>
            <div class="seperator">
            ...
            <div class="about-wrapper">
                ...
                <div class="wrapper-info">
                    <h5 class="wrapper-details about-details">Lakukan Pembayaran Anda</h5>
            ...
            <div class="about-wrapper">
                ...
                <div class="wrapper-info">
                    ...
                    <p>Nikmati belanja online tanpa repot dengan layanan kami, pengiriman cepat langsung ke rumah Anda.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="featured-text">
                    <h2 class="pb-3">Why <span class="orange-text">Sentuhan Seni</span></h2>
                    <div class="row">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 text-center">
                <div class="section-title">
                    <h3><span class="orange-text">Team</span></h3>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="single-team-item">
                    ...
                    <h4>Leonardo Da Vici<span>Seniman</span></h4>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-team-item">
                    ...
                    <h4>Henri Emile Benoit Matisse<span>Seniman</span></h4>
                    {{-- <ul class="social-link-team">
                        <li><a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="#" target="_blank"><i class="fab fa-twitter"></i></a></li>
                        <li><a href="#" target="_blank"><i class="fab fa-instagram"></i></a></li>
            ...
            <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                <div class="single-team-item">
                    ...
                    <h4>Pablo Ruiz Picasso<span>Seniman</span></h4>
                    {{-- <ul class="social-link-team">
                        <li><a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="#" target="_blank"><i class="fab fa-twitter"></i></a></li>
                        <li><a href="#" target="_blank"><i class="fab fa-instagram"></i></a></li>
