                ...
                <div class="header-nav">
                    <div class="header-nav-menu">
                        <ul class="menu-list">
                            ...
                            <li>
                                <a href="{{url('about')}}">
                                    <span class="list-text">Tentang</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="header-vendor-btn">
                        <a href="become-vendor.html" class="shop-btn">
                            <span class="list-text shop-text"></span>
                            <span class="icon">
        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12 text-center">
                <div class="main-menu-wrap">
                    ...
                    <div class="site-logo">
                        <a href="index.html">
                            <img src="{{asset('frontend/assets/img/logo.png')}}" alt="" width="80" height="70">
                        </a>
                    </div>
                    <!-- logo -->
                    ...
                    <nav class="main-menu">
                        <ul>
                            <li class="current-list-item"><a href="{{url('/')}}">Beranda</a>
                            </li>
                            <li><a href="{{url('produkt')}}">Produk</a>
                            ...
                            <li>
                                <div class="dropdown">
                                    ...
                                    <button type="button" class="btn btn-dark">
                                        <i class="fas fa-user"></i> <!-- Icon profil Font Awesome -->
                                        {{ Auth::user()->name }}
                                    </button>
