...
@section('content')
@php
$kategori = \App\Models\Kategori::orderBy('id', 'asc') ->get();
                    ...
                    <div class="col-lg-6">
                        <div class="wrapper-section" data-aos="fade-up">
                            <div class="wrapper-info">
                                <h1 class="wrapper-details">Kerajinan Pilihan Anda</h1>
                                <a href="{{url('produkt')}}" class="shop-btn">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="category-section">
            ...
            <div class="product-wrapper" data-aos="fade-right" data-aos-duration="100">
                <div class="wrapper-img">
                    <img src="{{asset('/images/kategori/' . $item->gambar)}}" alt="dress" width="170px" height="150px">
                </div>
                <div class="wrapper-info">
                    <a href="product-sidebar.html" class="wrapper-details">{{ $item->nama_kategori }}</a>
                </div>
            </div>
            @endforeach
        </div>
...
<section class="product arrival">
    <div class="container">
        <div class="section-title">
            <h5>Product</h5>
            <a href="produk" class="view">View All</a>
        </div>
                    ...
                    <div class="product-wrapper" data-aos="fade-up">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-description">
                                <a href="product-info.html" class="product-details">{{ $item->nama_produk }}
                                </a>
                                <div class="price">
                        ...
                        <div class="product-cart-btn">
                            ...
                            <a href="produk/{{$item->id}}" class="product-btn">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                @endforeach
...
<section class="product fashion-style">
    <div class="container">
        <div class="style-section">
            <div class="row gy-4 gx-5 gy-lg-0 mb-5">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="" data-aos="fade-up">
                        <div class="wrapper-info">
                            ...
                            <span class="wrapper-subtitle mt-5">SENTUHAN SENI</span>
                            <h5 class="wrapper-details">
                                <span class="wrapper-inner-title"></span>
                                Kerajinan yang dijual disini akan awet, karena
                ...
                <div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
                    <div class="hero-text">
                        <div class="hero-text-tablecell">
                            <p class="subtitle">Keren & Berkualitas</p>
                            <h1>Bahan Sederhana Hasil Indah</h1>
                            <div class="hero-btns">
                                <a href="{{url('produkt')}}" class="boxed-btn">Koleksi Produk</a>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1 text-center">
                    <div class="hero-text">
                        <div class="hero-text-tablecell">
                            <p class="subtitle">Keren & Berkualitas</p>
                            <h1>100% Bahan Tidak Ecek Ecek</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1 text-right">
                    <div class="hero-text">
                        <div class="hero-text-tablecell">
                            <p class="subtitle">Keren & Berkualitas</p>
                            <h1>Memperindah Ruangan Kamu</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                <div class="list-box d-flex align-items-center">
                    ...
                    <div class="content">
                        ...
                        <p>Ketika lebih dari Rp.50.000</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2 text-center">
                <div class="section-title">
                    <h3><span class="orange-text"></span> Produk</h3>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6 text-center">
                <div class="single-product-item">
                    <div class="product-image">
                        <a href="single-product.html"><img src="{{asset('/images/produk/' . $item->gambar)}}" alt="" width="200" height="300"></a>
                    </div>
                    <h3>{{$item->nama_produk}}</h3>
                    <p class="product-price"><span></span>Rp. {{$item->harga}}</p>
                    <a href="produk/{{$item->id}}" class="cart-btn"><i class="fas fa-shopping-cart"></i> Lihat Detail</a>
                </div>
            </div>
            @endforeach
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="abt-text">
                    ...
                    <h2>We are <span class="orange-text">Art</span></h2>
                    <p>Etiam vulputate ut augue vel sodales. In sollicitudin neque et massa porttitor vestibulum ac vel nisi. Vestibulum placerat eget dolor sit amet posuere. In ut dolor aliquet, aliquet sapien sed, interdum velit. Nam eu molestie lorem.</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente facilis illo repellat veritatis minus, et labore minima mollitia qui ducimus.</p>
                    <a href="{{url('about')}}" class="boxed-btn mt-4">Lihat lebih</a>
                </div>
            </div>
        </div>
    </div>
